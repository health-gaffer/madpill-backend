...
nohup java -jar -Dspring.profiles.active=prod -Djasypt.encryptor.password="$JASYPT_ENCRYPTOR_PASSWORD" madpill-backend-0.0.1-SNAPSHOT.jar < /dev/null > /dev/null 2>&1 &
